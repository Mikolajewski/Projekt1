...
*/
		...
		bool usun_konkretny_element(waga wartosc,typ* cel_poszukiwan);
		bool pop();
		void usun_wszystko();
/*!
\brief Metoda zwroc
...
//		cout<<"lista nie jest pusta"<<dlugosc_listy<<" "<<pomocnicza->zwroc_klucz()<<endl;
//		pomocnicza->wypisz();
//		wypisz();
...
template<sortowanie rodzaj_sortowania,class typ,class waga>            //<-------------------------------------------
bool Lista<rodzaj_sortowania,typ,waga>::usun_konkretny_element(waga wartosc,typ* cel_poszukiwan){
	Element<waga,typ>* pomocnicza=znajdz_element(wartosc);
	while(pomocnicza!=NULL && pomocnicza->zwroc_wartosc()!=cel_poszukiwan && pomocnicza->zwroc_klucz()==wartosc){
		pomocnicza=pomocnicza->zwroc_wskaznik();
	}
	if(pomocnicza->zwroc_wartosc()==cel_poszukiwan){

		if(pomocnicza->zwroc_wskaznik()!=NULL){
//				cout<<"wpisywanie         do syna"<<endl;
				pomocnicza->zwroc_wskaznik()->wpisz_ojciec(pomocnicza->zwroc_ojciec());
			}
			if(pomocnicza->zwroc_ojciec()!=NULL){

//				cout<<"wpisywanie        do ojca"<<endl;
...
template<sortowanie rodzaj_sortowania,class typ,class waga>
void Lista<rodzaj_sortowania,typ,waga>::usun_wszystko(){
	while(pop()==true);
}
#endif
