...
\end{DoxyReturn}
\hypertarget{class_program_a7278c6a0f493496979edc7b76fb7f368}{\index{Program@{Program}!wczytaj\-\_\-plik@{wczytaj\-\_\-plik}}
\index{wczytaj\-\_\-plik@{wczytaj\-\_\-plik}!Program@{Program}}
\subsubsection[{wczytaj\-\_\-plik}]{\setlength{\rightskip}{0pt plus 5cm}bool Program\-::wczytaj\-\_\-plik (
\begin{DoxyParamCaption}
\item[{char $\ast$}]{nazwa}
\end{DoxyParamCaption}
)}}\label{class_program_a7278c6a0f493496979edc7b76fb7f368}


Metoda wczytaj\-\_\-plik. 


\begin{DoxyParams}[1]{Parameters}
\mbox{\tt in}  & {\em Wskaznik} & do nazwy pliku, ktory ma zostac otwarty. \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Zwraca wartosc true, gdy operacja sie uda i plik zostanie poprawnie przepisany do strumienia lub wartosc false jesli operacja zakonczy sie niepowodzeniem. 
\end{DoxyReturn}
...
Reimplemented in \hyperlink{class_mnozenie_a540045a41aef8f58ecbf6c9afe606d85}{Mnozenie}.
...
Zawiera czas w ktorym zaczal wykonywac sie wlasciwy kod algorytmu (liczony od momentu uruchomienia programu). Do tej danej porownywany jest czas zakoczenia wykonywania algorytmu. \hypertarget{class_program_a7edd77bb13eb767fcbcabd5f2a4ae468}{\index{Program@{Program}!dlugosc\-\_\-tablicy@{dlugosc\-\_\-tablicy}}
\index{dlugosc\-\_\-tablicy@{dlugosc\-\_\-tablicy}!Program@{Program}}
...
Zawiera liczbe swiadczaco o dlugosci utworzonej tablicy dynamicznej. \hypertarget{class_program_a532ceacb1d70da66142bab96a3eb0753}{\index{Program@{Program}!plik\-\_\-wejsciowy@{plik\-\_\-wejsciowy}}
...
Zmienna przedstawiajaca strumien danych po wykonaniu wlasiwego algorytmu. \hypertarget{class_program_ad716e08410eb11cfd01ece6c459c1de1}{\index{Program@{Program}!tablica@{tablica}}
\index{tablica@{tablica}!Program@{Program}}
