...
class Pole{
	...
	*/
		Pole(){_dostepnosc=true;_odleglosc_od_poczatku=0;_prognozowany_koszt=0;_poprzednie_pole=NULL;_x=0;_y=0;_rodzaj_terenu=nic;};
		...
		void oznacz_pole_jako_maszynownia(){_rodzaj_terenu=maszynownia;};
