...
*/
		Element <klucz,wartosc>(){_ojciec=NULL;_wskaznik=NULL;_odleglosc=0;};
...
*/
		wartosc wpisz_wartosc(wartosc dana){_dana=dana;};
...
*/
		Element* wpisz_ojciec(Element<klucz,wartosc>* wskaznik){_ojciec=wskaznik;};
...
Wpisuje wskaznik do struktury typu Element.
*/
		Element* wpisz_wskaznik(Element<klucz,wartosc>* wskaznik){_wskaznik=wskaznik;};
...
/*!
\brief zwroc_odleglosc

\return Metoda zwracajaca wartosc pola odleglosc.
*/
...
void Element<klucz,wartosc>::wypisz(){
	cout<<"Klucz: "<<zwroc_klucz()<<" Klucz2: "<<zwroc_klucz2()<<" Waga: "<<zwroc_wage()<<endl;
}
#endif
