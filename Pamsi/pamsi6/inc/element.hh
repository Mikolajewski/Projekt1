...
*/
		Element <klucz,wartosc>(){_wskaznik_prawy=NULL;_wskaznik_lewy=NULL;_ojciec=NULL;_wskaznik=NULL;};
...
*/
		Element* wpisz_wskaznik(Element<klucz,wartosc>* wskaznik);
...
template<class klucz,class wartosc>
Element<klucz,wartosc>* Element<klucz,wartosc>::wpisz_wskaznik(Element<klucz,wartosc>* wskaznik){
	_wskaznik=wskaznik;
	return wskaznik;
}
